...
2. **Visual Job Scheduling & Management** — Schedule, pause, resume, cancel, or retry jobs interactively from the dashboard.
...
- [ ] Users can pause, resume, cancel, and retry jobs from the dashboard
